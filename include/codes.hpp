...
struct Codes {
  ...
  struct Error {
    ...
    static inline constexpr Code INVALID_DATA{404, "INVALID_DATA", "invalid data"};
    static inline constexpr Code METHOD_INCORRECT{404, "METHOD_INCORRECT", "method incorrect"};

    static inline constexpr Code TOKEN_GENERATE_ERR{500, "TOKEN_GENERATE_ERR", "tokenb idi naxyi"};
    static inline constexpr Code JSON_INVALID{422, "JSON_INVALID", "Couldn't read json from response"};
  };
};
