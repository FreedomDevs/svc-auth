...
inline const std::unordered_map<std::string_view, std::string_view> g_aaguid_map = {
    ...
    {"e8b7f4a2-c3d5-e6f7-890a-b1c2d3e4f567", "Sherlocked Passkey Provider (iOS) - Stashword Inc."},
    ...
    {"39a5647e-1853-446c-a1f6-a79bae9f5bc7", "IDmelon Key"},
